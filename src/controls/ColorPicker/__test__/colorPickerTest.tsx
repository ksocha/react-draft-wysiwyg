...
describe('ColorPicker test suite', () => {
  ...
  it('should have a div when rendered', () => {
    expect(mount(<ColorPicker onChange={() => {}} editorState={editorState} config={defaultToolbar.colorPicker} translations={localeTranslations.en} modalHandler={new ModalHandler()} />).html().startsWith('<div')).to.equal(true);
  });

  it('should correctly set default state values', () => {
    const control = mount(<ColorPicker onChange={() => {}} editorState={editorState} config={defaultToolbar.colorPicker} translations={localeTranslations.en} modalHandler={new ModalHandler()} />);
